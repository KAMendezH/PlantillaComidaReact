...
function SeccionMenu(  { productos, tel } ){
    ...
    return(
        <div className="seccion__menu" id="seccionMenu">
            ...
            <section className="menu__contenedor">
                ...
                <h3 className="h3__seccion__menu">Alimentos</h3>
                <FlexConteiner info={ productosState.filter(producto => producto.seccion === "Alimentos") } setProductos={setProductosState}/>
                <h3 className="h3__seccion__menu">Bebidas</h3>
                <FlexConteiner info={ productosState.filter(producto => producto.seccion === "Bebidas") } setProductos={setProductosState}/>
                <h3 className="h3__seccion__menu">Postres</h3>
                <FlexConteiner info={ productosState.filter(producto => producto.seccion === "Postres") }     setProductos={setProductosState}/>
            </section>
